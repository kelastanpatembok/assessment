import { ab as head, ad as escape_html, a5 as derived, ae as ensure_array_like, ar as attr_style, aq as stringify } from './dev-DBdtSqNh.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let scores = derived(() => traits.map((t) => ({
			key: t,
			name: traitNames[t] ?? t,
			value: r()?.[`result${t}`] ?? 0
		})));
...
//# sourceMappingURL=_page.svelte-BubeEprp.js.map
