...
public class DiscScoringService {
    ...
    public DiscResult scoreAndSave(String authUserId, String studentName, String schoolName,
        ...
        DiscResult result = DiscResult.builder()
                ...
                .mostDConv(mostConv.d()).mostIConv(mostConv.i()).mostSConv(mostConv.s()).mostCConv(mostConv.c())
                .leastDConv(leastConv.d()).leastIConv(leastConv.i()).leastSConv(leastConv.s()).leastCConv(leastConv.c())
                .difDConv(difConv.d()).difIConv(difConv.i()).difSConv(difConv.s()).difCConv(difConv.c())
